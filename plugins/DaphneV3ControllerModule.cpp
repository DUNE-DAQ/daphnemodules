...
namespace dunedaq::daphnemodules {
  ...
  void DaphneV3ControllerModule::do_start(const CommandData_t& )  { ; }
  ...
  void DaphneV3ControllerModule::configure_analog_chain(bool initial_config) {
    ...
    auto response = m_iface.load()->send<daphne::ConfigureResponse>( req.SerializeAsString(),
								     daphne::MT2_CONFIGURE_FE_REQ,
